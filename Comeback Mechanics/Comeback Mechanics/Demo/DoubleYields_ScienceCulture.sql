...
-- New requirement types, sets, and details --
INSERT INTO Types (Type, Kind) VALUES ('REQIREMENT_PLAYER_FELL_BEHIND_SAM', 'KIND_REQUIREMENT');

INSERT INTO Requirements (RequirementId, RequirementType, Likeliness, Impact, Reverse, Persistent, ProgressWeight, Triggered) VALUES ('REQUIRES_HAS_BEHIND_SCIENCE_SAM', 'REQIREMENT_PLAYER_FELL_BEHIND_SAM', 0, 0, 0, 0, 1, 0);
INSERT INTO Requirements (RequirementId, RequirementType, Likeliness, Impact, Reverse, Persistent, ProgressWeight, Triggered) VALUES ('REQUIRES_HAS_BEHIND_CULTURE_SAM', 'REQIREMENT_PLAYER_FELL_BEHIND_SAM', 0, 0, 0, 0, 1, 0);
