...
--INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, NewOnly, Permanent, Repeatable, SubjectRequirementSetId) VALUES ('GREATPERSON_CAMPUS_PROPHET_POINTS_SAM', 'MODIFIER_SINGLE_CITY_DISTRICTS_ADJUST_GREAT_PERSON_POINTS', 1, 0, 1, 0, 'DISTRICT_IS_CAMPUS');
